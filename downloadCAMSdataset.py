...
c.retrieve(
    'cams-global-ghg-reanalysis-egg4',
    {
        ...
        'model_level': '60', #This is set to 60 because the level 60 refers the earth surface while 1 refers top of the atmosphere. 
    ...
    os.path.join(output_dir,f'cams_europe.nc')
)
